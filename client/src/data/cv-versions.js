...
export const cvVersions = [
  ...
  },
  {
    ...
    content: {
      ...
      title: 'Technical Project Manager & Developer',
      bio:
        'A versatile B.Sc. Computer Science graduate and Certified Project Manager, blending strong full-stack software development capabilities with hands-on experience leading end-to-end technical projects. Proven track record in driving Digital Transformation, engineering automated data pipelines, and architecting custom AI-driven software solutions that reduce administrative overhead by 50%. Adept at managing cross-functional workflows, navigating strict data protocols, and bridging the gap between complex code and business-critical operations. Equipped to deliver immediate value in positions that require a unique combination of technical depth and systemic execution.',
      contact: {
        ...baseContent.contact,
        website: 'https://portfolio-david-monsonego.vercel.app',
      },
      ...
      experience: [
        {
          ...
          year: '2023 – Present',
          bullets: [
            'Led a large-scale digital transformation of unit information systems, cutting administrative workload by 50% through tailored automation and custom-built software.',
            'Architected and developed a full-stack HR management application from scratch using React, deployed via Vercel, with a secure Supabase (PostgreSQL) backend.',
            'Engineered automated data pipelines and Looker Studio dashboards, drastically improving reporting latency, data accuracy, and decision-making for senior command.',
            'Managed technical product delivery and training across the unit, translating complex system architectures into simple workflows for diverse teams in high-pressure environments.',
          ],
        },
        {
          title: 'Branch & Technical Operations Manager',
          ...
          year: '2013 – 2019',
          bullets: [
            'Managed end-to-end technical and logistics operations utilizing Priority ERP, optimizing supply chain, inventory control, and multi-layered process accuracy.',
            'Supervised and coached a multi-disciplinary technical team, establishing rigorous service standards, performance KPIs, and technical training frameworks.',
            'Translated complex hardware and software architectures into tailored, clear-cut technical solutions for corporate clients and internal tool upgrades.',
          ],
        },
      ],
      languages: [
  ...
  },
  {
    ...
    content: {
      ...
      bio:
        'Computer Science B.Sc. graduate with practical experience in software development, system implementation, and database optimization. Highly proficient in JavaScript and SQL, with practical familiarity with PHP code structures. Proven track record of improving operational efficiency by adapting quickly to complex corporate workflows and configuring digital tools. Possesses full professional proficiency in English, strong team-work capabilities, and a fast learning curve, ready to integrate into enterprise ERP development and collaborate with international interfaces.',
      contact: {
        ...baseContent.contact,
        website: 'https://portfolio-david-monsonego.vercel.app',
      },
      ...
      skills: [
        'Programming Languages: Python, SQL, PostgreSQL, JavaScript, PHP, TypeScript, React, Java, C',
        'Data & Analytics: Advanced Excel, Looker Studio, Power BI, Data Pipelines',
        'Infrastructure & Cloud: Docker, Linux (CLI & Shell Scripting), Windows, GitHub, Familiarity with AWS & VMware',
        'Tools & Systems: Priority ERP, Cursor, Claude Code, Make, Zapier, Airtable, Google Apps Script',
      ],
      experience: [
        {
          title: 'Technical Project Manager & Developer',
          ...
          year: '2023 – Present',
          bullets: [
            'Built a full-stack HR and personnel management application using JavaScript frameworks, deployed on Vercel with a Supabase (PostgreSQL) backend.',
            'Designed and automated data pipelines using custom scripts and Looker Studio, which improved data accuracy and reporting speed for senior command.',
            'Led a digital transformation initiative for unit personnel systems, reducing manual administrative workload by 50% through targeted workflow automation.',
            'Wrote custom scripts and integrated digital tools to streamline logistics and reporting processes under high-pressure environments.',
          ],
        },
        {
          title: 'Branch & Technical Operations Manager',
          ...
          year: '2013 – 2019',
          bullets: [
            'Managed daily technical operations and inventory control directly through Priority ERP, maintaining maximum data accuracy and streamlining store workflows.',
            'Analyzed and optimized internal retail processes within the ERP system, collaborating with purchasing, logistics, and supply chain interfaces.',
            'Supervised and trained cross-functional teams, emphasizing the correct adoption of computerized methodologies and adherence to operational targets.',
          ],
        },
      ],
      projects: [
        {
          name: 'ERP Inventory Demo',
          tech: ['PHP', 'JavaScript'],
          year: '2026',
          description: 'Full-stack decoupled dashboard for operational logistics.',
          link: 'https://github.com/DudiMonsonego/erp-inventory-demo',
        },
        {
          name: 'IDF HR System',
          tech: ['React', 'PostgreSQL', 'Supabase'],
